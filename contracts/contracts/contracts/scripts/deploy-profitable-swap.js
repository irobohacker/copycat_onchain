...
async function deployContracts() {
    ...
    await swapLottery.waitForDeployment();
    const swapLotteryAddress = await swapLottery.getAddress();
    ...
    await profitableSaucerSwap.waitForDeployment();
    const profitableSaucerSwapAddress = await profitableSaucerSwap.getAddress();
